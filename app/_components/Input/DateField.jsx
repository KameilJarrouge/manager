...
function DateField({ state, setState, placeholder = "Created At" }) {
    ...
    <div id="data-input-container" className="w-fit h-fit relative">
      ...
      {isDateMenuOpen && (
        <div
          id="date-menu"
          tabIndex={"1"}
          className="absolute bottom-[2.1rem] left-[0rem] w-fit p-0.5 pt-1 h-fit bg-secondary border border-input_bg shadow shadow-black z-10"
        >
          <CalendarSelect
            initialDate={state}
            onSelect={(date) => {
